    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item <?php echo e(request()->is('admin/users*') || request()->is('admin/drivers*') || request()->is('admin/provider-details*') ? 'menu-open' : ''); ?>">
                ...
                <li class="nav-item <?php echo e(request()->is('services*') || request()->is('deliveries*') || request()->is('types*') || request()->is('categories*') || request()->is('products*') ? 'menu-open' : ''); ?>">
                    <a href="#" class="nav-link">
                ...
                <li class="nav-item <?php echo e(request()->is('admin/payment-report*') ? 'menu-open' : ''); ?>">
                    ...
                    <ul class="nav nav-treeview">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['payment-table', 'payment-add', 'payment-edit', 'payment-delete'])): ?>
                        <li class="nav-item">
                            <a href="<?php echo e(route('admin.payment.report')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.payment.report') ? 'active' : ''); ?>">
                                <i class="fas fa-handshake nav-icon"></i>
...
</aside><?php /**PATH C:\xampp\htdocs\glovana\resources\views/admin/includes/sidebar.blade.php ENDPATH**/ ?>