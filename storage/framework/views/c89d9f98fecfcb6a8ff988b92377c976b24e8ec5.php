        ...
        <div class="col-md-10 offset-md-1">
            <div class="card">
                <div class="card-header">
                    <h4><?php echo e(__('messages.Edit_Discount')); ?>: <?php echo e($discount->name); ?></h4>
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('discounts.update', [$providerId, $providerType->id, $discount->id])); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                           id="name" name="name" value="<?php echo e(old('name', $discount->name)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                              id="description" name="description" rows="3"><?php echo e(old('description', $discount->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                               id="percentage" name="percentage" value="<?php echo e(old('percentage', $discount->percentage)); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                                   id="start_date" name="start_date" value="<?php echo e(old('start_date', $discount->start_date->format('Y-m-d'))); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                                   id="end_date" name="end_date" value="<?php echo e(old('end_date', $discount->end_date->format('Y-m-d'))); ?>" required>
...
unset($__errorArgs, $__bag); ?>" style="max-height: 250px; overflow-y: auto;">
                                        <div class="mb-2 border-bottom pb-2">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="all_services" 
                                                       <?php echo e(empty($selectedServiceIds) ? 'checked' : ''); ?> onchange="toggleAllServices()">
                                        ...
                                        <div id="specific-services" style="<?php echo e(empty($selectedServiceIds) ? 'display: none;' : ''); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                                        ...
                                        <option value="1" <?php echo e(old('is_active', $discount->is_active) == '1' ? 'selected' : ''); ?>>
                                            <?php echo e(__('messages.Active')); ?>

                                        </option>
                                        <option value="0" <?php echo e(old('is_active', $discount->is_active) == '0' ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mt-4">
                            <div class="col-md-12">
                                <div class="alert <?php echo e($discount->isCurrentlyActive() ? 'alert-success' : 'alert-warning'); ?>">
                                    <h6><i class="fas fa-info-circle"></i> <?php echo e(__('messages.Current_Status')); ?></h6>
                                    <?php if($discount->isCurrentlyActive()): ?>
                                        <p class="mb-0"><?php echo e(__('messages.This_discount_is_currently_active')); ?></p>
                                    <?php elseif($discount->start_date > now()): ?>
                                        <p class="mb-0"><?php echo e(__('messages.This_discount_will_start_on')); ?> <?php echo e($discount->start_date->format('Y-m-d')); ?></p>
                                    <?php else: ?>
                                        <p class="mb-0"><?php echo e(__('messages.This_discount_has_expired')); ?></p>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mt-2">
                            <div class="col-md-12">
                                <div class="alert alert-info">
                                    <h6><i class="fas fa-eye"></i> <?php echo e(__('messages.Discount_Preview')); ?></h6>
                                    <div id="discount-preview">
                                        <?php echo e(__('messages.Loading_preview')); ?>
                        ...
                        <div class="row mt-4">
                            <div class="col-md-12">
                                <button type="submit" class="btn btn-primary"><?php echo e(__('messages.Update_Discount')); ?></button>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\glovana\resources\views/admin/discounts/edit.blade.php ENDPATH**/ ?>