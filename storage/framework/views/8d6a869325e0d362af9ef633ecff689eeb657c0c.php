        ...
        <div class="col-xl-3 col-md-6">
            <div class="card card-h-100">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            <span class="text-muted mb-3 lh-1 d-block text-truncate"><?php echo e(__('messages.hourly_appointments')); ?></span>
                            <h4 class="mb-3"><?php echo e(number_format($statistics['hourly_appointments'])); ?></h4>
                        </div>
                        <div class="flex-shrink-0">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card card-h-100">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            <span class="text-muted mb-3 lh-1 d-block text-truncate"><?php echo e(__('messages.service_appointments')); ?></span>
                            <h4 class="mb-3"><?php echo e(number_format($statistics['service_based_appointments'])); ?></h4>
                        </div>
                        <div class="flex-shrink-0">
                ...
                <div class="card-body">
                    <form method="GET" action="<?php echo e(route('appointments.index')); ?>">
                        <div class="row g-3">
                            ...
                            <div class="col-md-3">
                                <label class="form-label"><?php echo e(__('messages.booking_type')); ?></label>
                                <select name="booking_type" class="form-control">
                                    <option value=""><?php echo e(__('messages.all_types')); ?></option>
                                    <option value="hourly" <?php echo e(request('booking_type') == 'hourly' ? 'selected' : ''); ?>><?php echo e(__('messages.hourly')); ?></option>
                                    <option value="service" <?php echo e(request('booking_type') == 'service' ? 'selected' : ''); ?>><?php echo e(__('messages.service_based')); ?></option>
                                </select>
                            </div>
                            <div class="col-md-3">
                            ...
                            <table class="table table-bordered table-striped">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th><?php echo e(__('messages.booking_type')); ?></th>
                                        <th><?php echo e(__('messages.services_details')); ?></th>
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $appointments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appointment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge <?php echo e($appointment->booking_type == 'service' ? 'bg-primary' : 'bg-secondary'); ?>">
                                                    <?php echo e($appointment->booking_type == 'service' ? __('messages.service_based') : __('messages.hourly')); ?>

                                                </span>
                                            </td>
                                            <td>
                                                <?php if($appointment->booking_type == 'service'): ?>
                                                    <div class="small">
                                                        <strong><?php echo e(__('messages.services')); ?>:</strong> <?php echo e($appointment->services_summary['total_services']); ?><br>
                                                        <strong><?php echo e(__('messages.customers')); ?>:</strong> <?php echo e($appointment->services_summary['total_customers']); ?><br>
                                                        <?php if($appointment->services_summary['services']->count() > 0): ?>
                                                            <div class="mt-1">
                                                                <?php $__currentLoopData = $appointment->services_summary['services']->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <span class="badge bg-light text-dark me-1"><?php echo e($service['name']); ?> (<?php echo e($service['customer_count']); ?>)</span>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                <?php if($appointment->services_summary['services']->count() > 2): ?>
                                                                    <span class="text-muted">+<?php echo e($appointment->services_summary['services']->count() - 2); ?> <?php echo e(__('messages.more')); ?></span>
                                                                <?php endif; ?>
                                                            </div>
                                                        <?php endif; ?>
                                                    </div>
                                                <?php else: ?>
                                                    <div class="small text-muted">
                                                        <?php echo e(__('messages.hourly_booking')); ?><br>
                                                        <strong><?php echo e(__('messages.rate')); ?>:</strong> <?php echo e(number_format($appointment->providerType->price_per_hour, 2)); ?> <?php echo e(__('messages.jd')); ?>/<?php echo e(__('messages.hour')); ?>
