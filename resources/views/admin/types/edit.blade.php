                    ...
                    <form action="{{ route('types.update', $type->id) }}" method="POST" enctype='multipart/form-data'>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" 
                                   ...
                                   id="minimum_order" 
                                   name="minimum_order" 
                                   value="{{ old('minimum_order', $type->minimum_order) }}" 
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control @error('booking_type') is-invalid @enderror" 
                                ...
                                <option value="hourly" {{ old('booking_type', $type->booking_type) == 'hourly' ? 'selected' : '' }}>
                                    {{ __('messages.Hourly_Booking') }}
                                </option>
                                <option value="service" {{ old('booking_type', $type->booking_type) == 'service' ? 'selected' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control @error('have_delivery') is-invalid @enderror" 
                                ...
                                <option value="1" {{ old('have_delivery', $type->have_delivery) == 1 ? 'selected' : '' }}>
                                    {{ __('messages.Yes') }}
                                </option>
                                <option value="2" {{ old('have_delivery', $type->have_delivery) == 2 ? 'selected' : '' }}>
                                    {{ __('messages.No') }}
                                </option>
                            </select>
                            @error('have_delivery')
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                @if($type->photo)
                                    <img src="{{ asset('assets/admin/uploads/' . $type->photo) }}" 
                                         id="current-image" 
                                         alt="Current Image" 
                                         height="50px" 
                                         width="50px" 
