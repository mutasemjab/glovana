...
@section('title', __('messages.View_provider'))

@section('content')
<div class="container-fluid">
    <!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">{{ __('messages.View_provider') }}</h1>
        <div>
        ...
        <div class="col-lg-4">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body text-center">
                    @if($provider->photo)
                    <img src="{{ asset('assets/admin/uploads/' . $provider->photo_of_manager) }}"  class="img-profile rounded-circle mb-3" style="width: 150px; height: 150px; object-fit: cover;">
                    @else
                    ...
                    @endif
                    <h4 class="font-weight-bold">{{ $provider->_of_manager }}</h4>
                        ...
                        <table class="table table-bordered">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $provider->email ?? __('messages.Not_Available') }}</td>
                                </tr>
                                <tr>
