            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('sold') is-invalid @enderror" 
                                           id="sold" name="sold" value="{{ old('sold') }}" 
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('tax') is-invalid @enderror" 
                                           id="tax" name="tax" value="{{ old('tax') }}" step="0.01" min="0" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('specification_en') is-invalid @enderror" 
                                              id="specification_en" name="specification_en" rows="3">{{ old('specification_en') }}</textarea>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('specification_ar') is-invalid @enderror" 
                                              id="specification_ar" name="specification_ar" rows="3">{{ old('specification_ar') }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h5 class="mb-3">{{ __('messages.Product_Images') }}</h5>
