                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('lat') is-invalid @enderror" 
                                           id="lat" name="lat" value="{{ old('lat') }}" step="any" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('lng') is-invalid @enderror" 
                                           id="lng" name="lng" value="{{ old('lng') }}" step="any" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('number_of_work') is-invalid @enderror" id="number_of_work" name="number_of_work">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control @error('status') is-invalid @enderror" 
                                        ...
                                        <option value="1" {{ old('status') == '1' ? 'selected' : '' }}>{{ __('messages.On') }}</option>
                                        <option value="2" {{ old('status') == '2' ? 'selected' : '' }}>{{ __('messages.Off') }}</option>
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control @error('is_vip') is-invalid @enderror" 
                                        ...
                                        <option value="1" {{ old('is_vip') == '1' ? 'selected' : '' }}>{{ __('messages.VIP') }}</option>
                                        <option value="2" {{ old('is_vip') == '2' ? 'selected' : '' }}>{{ __('messages.Regular') }}</option>
                                    </select>
